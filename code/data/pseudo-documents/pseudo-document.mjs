...
export default class PseudoDocument extends foundry.abstract.DataModel {
  ...
  /** @inheritdoc */
  static LOCALIZATION_PREFIXES = ["HOLLOWS.Pseudo"];
   ...
   */
  get sheet() {
    return hollows.applications.api.PseudoDocumentSheet.getSheet(this);
  }
  ...
  static async createDialog(data = {}, { parent, ...operation } = {}) {
    ...
    const result = await hollows.applications.api.HollowsDialog.input({
      content,
      window: {
   ...
   * @param {Event} event
   * @param {hollows.applications.api.HollowsDialog} dialog
   * @protected
   */
