/**
 * @import HollowsRPGUser from "../documents/user.mjs";
 ...
 * @param {HollowsRPGUser} context.user
 * @param {Array<HollowsRPGUser>} context.users List of users or userId who can see the roll, leave it empty if everyone can see.
